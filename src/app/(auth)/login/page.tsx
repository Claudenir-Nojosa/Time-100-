        ...
        <div className="isolate">
          ...
          >
            <div
              ...
              className="relative left-[calc(0%-11rem)] aspect-[1155/678] w-[36.600rem] -translate-x-1/2 rotate-[210deg] bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-green-700 via-green-300 to-green-800 opacity-25 sm:left-[calc(46%-30rem)] sm:w-[102.1875rem]"
            />
          </div>
        </div>
      </div>
